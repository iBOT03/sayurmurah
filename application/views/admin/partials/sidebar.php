        ...
        <div class="scrollbar-inner">
            ...
            <div class="sidenav-header  align-items-center">
                <a class="navbar-brand" href="javascript:void(0)">
                    <img src="<?= base_url(); ?>asset/img/brand/logo-sayurmurah.png" style="width: 200px"
                        class="navbar-brand-img" alt="...">
                        <!-- <img src="<?= base_url(); ?>asset/vendor/assets/img/brand/blue.png" class="navbar-brand-img" alt="..."> -->
                </a>
            </div>

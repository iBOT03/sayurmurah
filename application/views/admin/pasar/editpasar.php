                        ...
                        <div class="col-lg-6 col-7">
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Data Pasar</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card bg-white">
                        <div class="card-header bg-transparent">
                            <div class="row align-items-center">
                                <div class="col">
                                    <form method="post" action="<?= site_url('admin/pasar/edit/' . $detail[0]->id_pasar) ?>" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                <input name="id" id="id" class="form-control" type="hidden" placeholder="Masukkan nama pasar ..." id="example-text-input" value="<?= $detail[0]->id_pasar; ?>">
                                                    <label for="example-text-input" class="form-control-label">Nama Pasar</label>
                                                    <input name="nama" id="nama" class="form-control" type="text" placeholder="Masukkan nama pasar ..." id="example-text-input" value="<?= $detail[0]->nama_pasar; ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="daerah" name="daerah">
                                                        ...
                                                        <?php foreach ($daerah as $row) { ?>
                                                            <option value="<?= $row->id_daerah; ?>" <?= ($data[0]->id_daerah == $row->id_daerah ? 'selected' : '') ?>>
                                                                <?= $row->nama_daerah; ?></option>
                                                        <?php } ?>
                                                    </select>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php foreach ($detail as $data) { ?>
                                                        <a href="<?= base_url('uploads/admin/pasar/') . $data->foto_pasar ?>">Lihat Foto</a>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="lokasi" id="lokasi" class="form-control" placeholder="Masukkan alamat detail pasar ..." id="example-email-input"><?= $detail[0]->alamat_pasar; ?></textarea>
                                            <?= form_error('lokasi', '<small style="padding-left: 0; margin-left: 0;" class="text-danger pl-2">', '</small>'); ?>
                                        </div>

                                        <div class="form-group">
                                            <a href="<?= base_url("admin/pasar") ?>" class="btn btn-icon btn-danger" type="submit" style="margin-bottom: 0px">
                                                <span class="btn-inner--icon"><i class="ni ni-bold-left"></i></span>
                                                <span class="btn-inner--text">Kembali</span>
                                            </a>
                                            <button href="<?= base_url("admin/pasar") ?>" class="btn btn-icon btn-success" type="submit">
                                                <span class="btn-inner--icon"><i class="ni ni-cloud-upload-96"></i></span>
                                                <span class="btn-inner--text">Ubah Pasar</span>
                                            </button>
                                        </div>
                                    </form>
                                </div>
